...
def patch_crypten_inprocess():
    ...
    if getattr(InProcessCommunicator, "_aegisx_patched", False):
        return
    ...
    InProcessCommunicator._aegisx_patched = True
...
def patch_crypten_windows_multiprocess():
    ...
    if getattr(DistributedCommunicator, "_aegisx_windows_mp_patched", False):
        return
    ...
    DistributedCommunicator._aegisx_windows_mp_patched = True
